...
def importar_alunos():
    ...
    nome_col = next((h for h in ["nome", "aluno", "nome completo"]), None)
    matricula_col = next((h for h in ["matricula", "matricula aluno", "ra"]), None)
    turma_col = next((h for h in ["turma", "serie", "classe"]), None)
